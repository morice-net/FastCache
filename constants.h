...
const QMap<QString, int> CACHE_TYPE_MAP = {
    {"Traditionnelle",2},
    {"Multiple", 3},
    {"Virtuelle", 4},
...
const QMap<QString, int> CACHE_TYPE_INDEX_MAP = {
    {"0",2},
    {"2", 3},
    {"10", 4},
    {"8", 5},
...
const QMap<QString, int> CACHE_SIZE_MAP = {
    {"Inconnue"  , 1},
    {"Micro" , 2},
    {"Petite" , 8},
    {"Normale" , 3},
...
// Size of caches
const QMap<QString, int> CACHE_SIZE_INDEX_MAP = {
    {"6"  , 1},
    {"0" , 2},
    {"1" , 8},
    {"2" , 3},
...
const QMap<QString, int> LOG_TYPE_CACHE_MAP = {
    {"Trouvée" , 2},
    {"Non trouvée" , 3},
    {"Note" , 4},
    {"Archivée" , 5},
...
const QMap<QString, int> LOG_TYPE_TB_MAP = {
    {"Note", 4},
    {"Récupéré", 13},
    {"Déposé", 14},
    {"Transfert", 15},
...
// Type of logs (icons)
const QMap<QString, int> LOG_TYPE_ICON_MAP = {
    {"logTypes/marker_found_offline.png" , 2},
...
const QMap<QString, int> WPT_TYPE_MAP = {
    {"Parking" , 217},
    {"Enigme" , 218},
    {"Etape" , 219},
    {"Etape finale" , 220},
