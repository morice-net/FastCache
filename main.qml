...
Item {
    ...
    SQLiteStorage {
        ...
        Component.onCompleted: {
            // Build database
            sqliteStorage.createTable("fullcache", "(id string primary key, json string, name string, type string, size string, difficulty decimal,
                                        terrain decimal, lat double, lon double )");
